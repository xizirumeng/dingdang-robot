...
class Mic:
    ...
    def fetchThreshold(self):
        ...
        stream = self._audio.open(format=pyaudio.paInt32,
                                  channels=1,
                                  rate=RATE,
                                  input=True,
    ...
    def passiveListen(self, PERSONA):
        ...
        # prepare recording stream
        stream = self._audio.open(format=pyaudio.paInt32,channels=1,rate=RATE,input=True,frames_per_buffer=CHUNK)
        ...
        with tempfile.NamedTemporaryFile(mode='w+b') as f:
            ...
            wav_fp.setsampwidth(pyaudio.get_sample_size(pyaudio.paInt32))
